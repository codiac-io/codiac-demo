...
export class pgSelectComponent implements OnInit, AfterContentInit, AfterContentChecked, ControlValueAccessor {
  ...
  onTouched: () => void = () => null;
  @ViewChild('searchInput', {static: true}) searchInputElementRef;
  ...
  onClick(e: MouseEvent): void {
    ...
    if (!this._disabled) {
      ...
      if (this.ShowSearch) {
        ...
        setTimeout(_ => {
          // TODO: refactor, all this is garbage. this is what i get for buying controls from designers :(
         if( this.searchInputElementRef) this.searchInputElementRef.nativeElement.focus();
        });
      }
    }
  }
