...
@Component({
  ...
  <span class="nav-tabs-navigator left btn btn-link" (click)="_scrollHeader('before')" [class.disabled]="_disableScrollBefore" >
  ...
  <span class="nav-tabs-navigator right btn btn-link" (click)="_scrollHeader('after')" [class.disabled]="_disableScrollAfter" >
...
export class pgTabsNavComponent implements AfterContentChecked, AfterContentInit {
  ...
  set ShowPagination(value: boolean) {
    ...
    this._showPaginationControls = toBoolean(value);
  }
  ...
  ngAfterContentInit(): void {
    this._realignInkBar = this._ngZone.runOutsideAngular(() => {
      ...
      const resize = typeof window !== 'undefined' ?
        ...
        of(null);
      return merge(dirChange, resize).pipe(startWith([])).subscribe(() => {
        if (this.ShowPagination) {
          this._updatePagination();
        }
        this._alignInkBarToSelectedTab();
